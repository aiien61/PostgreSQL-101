...
-- 9. Select count of weight where gm_wgt is greater than 150 and less than 200
SELECT COUNT(*)
FROM weight
...
-- 12. How many records in food_des are not about food group Breakfast Cereals. 
...
-- 13. Find all the records in data sourcs that where between 1990 and 2000 and either 'j. Food Protection' or 'Food Chemistry'
SELECT *
FROM data_src
WHERE (year BETWEEN 1990 AND 2000) 
AND (journal = 'j. Food Protection' OR journal = 'Food Chemistry')
...
-- 15. Select all records from the data source table that were published in years 1960, 1970, 1980, 1990, 2000 Using IN syntax
SELECT *
FROM data_src
